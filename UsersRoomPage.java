...
public class UsersRoomPage extends BasePage{
	
	public UsersRoomPage(WebDriver driver) {
	...
	private By Rooms = 
			By.xpath("//button[normalize-space()='rooms']");
	...
	public boolean isMaxiumBookingperMonthDisplayed() {
...
public boolean isMaxiumByDurationDisplayed() {
...
public boolean isNumberofBookingDisplayed() {
	
	return isDisplayed(numberofbooking);
}
...
public boolean MaxiumallowedperdayDisplayed() {
	
	return isDisplayed(Maximumallowedperday);
